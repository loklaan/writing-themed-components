...
/*
|-------------------------------------------------------------------------------
| Same as before with user styles, but we'll compose the button
| behind a component that maps theme variables to a dynamic user style.
|
| This is theming! With a basic example, we've accomplished two
| requirements of theming:
